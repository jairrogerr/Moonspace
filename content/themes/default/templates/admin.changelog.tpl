<div class="card">
    ...
    <div class="card-body">
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] Moonspace Libs [AWS|HTMLPurifier|PHPMailer|SimpleImage|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [tagify]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|GettextTranslator|PHPMailer|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [easytimer|tagify|tinymce]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [Agora|AWS|Embed|FtpClient|GettextTranslator|GoogleAuthenticator|PHPMailer|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [jQuery|Agora|autosize|bootstrap.colorpicker|codemirror|easytimer|tagify|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|GettextTranslator|HybridAuth|MobileDetect|PHPMailer|SimpleImage|Smarty|Spaces|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [autosize|bootstrap.colorpicker|codemirror|easytimer|mustache|tagify|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|Faker|FTP|HybridAuth|MobileDetect|PHPMailer|SimpleImage|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [bootstrap.datetimepicker|codemirror|easytimer|moment|mustache|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Bootstrap|Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|HTMLPurifier|HybridAuth|PHPMailer|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [bootstrap.select|codemirror|dataTables|easytimer|fluidplayer|moment|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Bootstrap|Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|FTP|HybridAuth|PHPMailer|ReCaptcha|Smarty|Stripe|Twilio|2Checkout]</li>
            <li>[Updated] Moonspace JS Dependencies [jQuery|bootstrap.select|codemirror|easytimer|jquery.form|moment|mustache|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Bootstrap|Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Faker|HybridAuth|PHPMailer|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [bootstrap.colorpicker|codemirror|easytimer|mustache|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Bootstrap|Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|Faker|PHPMailer|reCAPTCHA|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [bootstrap.select|codemirror|datatables|easytimer|mustache|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [codemirror|mustache|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
            ...
            <li>[Fixed] Minor Bugs</li>
            <li>[Removed] Intl PHP extension as requirement for Moonspace</li>
        </ul>
        <div class="divider"></div>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|HybridAuth v3|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [jQuery|bootstrap.colorpicker|bootstrap.select|codemirror|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [bootstrap|mustache|jquery-ui|datatables|bootstrap.colorpicker|bootstrap.datetimepicker|bootstrap.select|codemirror|moment|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
            <li>[Added] Moonspace Default Theme v2.0 with Bootsrap 4+</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|HybridAuth|PHPMailer|ReCaptcha|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [mustache|bootstrap.select|codemirror|metismenu|moment|readmore|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|HybridAuth|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [autosize|bootstrap.colorpicker|codemirror|datatables|mediaelement|metismenu|moment|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [jQuery|dataTables|mediaelement|metisMenu|moment|noty|tinymce]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome|Flag-Icon]</li>
        ...
        <ul class="change-log-list mb20">
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [Twilio]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome(v5)]</li>
            <li>[Added] Forums</li>
        ...
        <ul class="change-log-list mb20">
            <li>[Updated] System Security</li>
            <li>[Updated] System Optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|ReCaptcha|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [jQuery|jquery.form|jquery.inview|jquery.geocomplete|autosize|moment|mediaelementplayer|bootstrap.select|bootstrap.datetimepicker|bootstrap.colorpicker|metisMenu|dataTables]</li>
            <li>[Updated] Installer Wizard & Pre-Installation Check</li>
            <li>[Updated] Moonspace GTmetrix Optimization</li>
            <li>[Updated] Moonspace Google PageSpeed Optimization</li>
        ...
        <ul class="change-log-list mb20">
            <li>[Updated] System optimization</li>
            <li>[Updated] Moonspace JS Dependencies [mediaelementplayer]</li>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Updated] System optimization</li>
            <li>[Updated] Moonspace Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|reCAPTCHA|Smarty|Stripe|Twilio]</li>
            <li>[Updated] Moonspace JS Dependencies [jQuery|Bootstrap|Mustache|html5shiv|slimscroll|autosize|readmore|moment|datetimepicker|DataTables]</li>
            <li>[Updated] Moonspace CSS Dependencies [Font-Awesome|Twemoji-Awesome|Flag-Icon]</li>
            <li>[Updated] Installer Wizard & Pre-Installation Check</li>
        ...
        <ul class="change-log-list mb20">
            <li>[Updated] Moonspace Libs [PHPMailer]</li>
        </ul>
        <div class="divider"></div>
        ...
        <ul class="change-log-list mb20">
            <li>[Updated] Moonspace Dependencies [Bootstrap|Font-Awesome|Flag-Icon|Twemoji-Awesome]</li>
        ...
        <ul class="change-log-list mb20">
            <li>[Updated] Moonspace Dependencies [Smarty|HybridAuth|Google reCAPTCHA]</li>
        </ul>
        <div class="divider"></div>
        ...
        <ul class="change-log-list mb20">
            ...
            <li>[Added] Update all Moonspace Dependencies to latest version</li>
        ...
        <ul class="change-log-list mb20">
            <li>[Added] Moonspace 2.1 Structure for better caching and performance</li>
            <li>[Added] Moonspace APIs v1.0</li>
