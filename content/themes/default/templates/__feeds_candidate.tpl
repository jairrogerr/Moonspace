<div class="job-candidate-wrapper">
    <div class="job-candidate-header">
        ...
        <div class="job-candidate-info">
            ...
            <div>
                <!-- message -->
                <button type="button" class="btn btn-sm btn-primary rounded-pill js_message-start" data-uid="{$candidate['user_id']}" data-name="{if $system['show_usernames_enabled']}{$candidate['user_name']}{else}{$candidate['user_firstname']} {$candidate['user_lastname']}{/if}" data-link="{$candidate['user_name']}">
