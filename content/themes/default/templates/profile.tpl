            ...
            <div class="profile-header">
                ...
                <div class="profile-cover-wrapper">
                    {if $profile['user_cover_id']}
                        ...
                        <!-- cropped-cover -->
                    {else}
                        <img class="js_position-cover-full" src="{$profile['user_cover']}">
                    {/if}
                ...
                <div class="profile-buttons-wrapper">
                    {if $user->_logged_in}
                        {if $user->_data['user_id'] != $profile['user_id']}
                            ...
                            <!-- message -->
                            <button type="button" class="btn btn-icon btn-rounded btn-primary mlr5 js_message-start" data-uid="{$profile['user_id']}" data-name="{$profile['name']}" data-link="{$profile['user_name']}">
