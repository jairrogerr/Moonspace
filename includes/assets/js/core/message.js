...
// initialize API URLs
/* chat */
api['chat/live'] = ajax_path + "messages/live.php";
api['chat/settings'] = ajax_path + "users/settings.php?edit=chat";
api['chat/call'] = ajax_path + "messages/call.php";
api['chat/reaction'] = ajax_path + "messages/reaction.php";
api['chat/post'] = ajax_path + "messages/post.php";
api['chat/messages'] = ajax_path + "messages/messages.php";
api['conversation/check'] = ajax_path + "messages/conversation.php?do=check";
api['conversation/get'] = ajax_path + "messages/conversation.php?do=get";
...
$(function () {
    ...
    $('body').on('click', '.js_message-start', function (e) {
