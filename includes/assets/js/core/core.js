...
$(function () {
    ...
    if (_p != 6 && _t[_t[0]] != _l) {
        document.write("Your session hash has been broken, Please contact Moonspace's support!");
    }
